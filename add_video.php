...
<head>
    ...
    <script>
        function ajax_kino_king() {
            var msg = $('#form_').serialize();
            $.ajax({
                type: 'POST',
                url: 'api.kinokong.php',
                data: msg,
                success: function (data) {

                    $('.myresult').html(data);
                   var getText = $('.myresult').text();

                    $('#rtsp_url').attr("value", getText);
...
<tr>
    <td>
    <form id="form_" enctype="multipart/form-data" method="POST" action="javascript:void(null);" onsubmit="ajax_kino_king();">
    <table align="center">
        <tr>
           <td align="right">
            <?= _('Title')?>:
        ...
        <tr>
           ...
           <?= _('Original title')?>:
            ...
            <td>
                ...
                <div class="myresult" id="myresult" style="visibility: hidden">
                </div>
        ...
        <tr>
            ...
            <label style="left: 50px; position: relative" class="label" for="linkKinoPoisk">Ссылка на kinokong:</label>

            <input style="left: 50px; position: relative; width: 260px;" type="text" name="linkKinoKong">

            <input style="left: 50px; position: relative" type="submit" name="kinokongbutton" value="Получить URL kinokong">
        ...
        <tr id="rtsp_url_block" <?if (@$protocol != 'custom'){ echo 'style="display:none"';}?>>
           ...
           <td>
            <input class="result" name="rtsp_url" id="rtsp_url" type="text" onblur="" size="40" value=""> (<?= _('include solution')?>)
           </td>
        </tr>
